...
print "<FORM ACTION=\"save_sourcesubnet.cgi\" METHOD=POST>\n",
      ...
      " <TR>\n",
      "  <TD $tb WIDTH=100%><B>",
      &text($in{'new'} ? 'essubnet_headeradd' : 'essubnet_header',
            "$st->{'ip'}/$st->{'prefix'}", $in{'sourcegroup'}),
      "</B></TD>\n",
      " </TR>\n",
      " <TR>\n",
      "  <TD>\n",
      ...
      "<INPUT TYPE=text NAME=prefix SIZE=2 VALUE=\"",
      $in{'new'} ? "" : $st->{'prefix'}, "\" MAXSIZE=2>",
      "     </TD>\n",
      "    </TR>\n",
